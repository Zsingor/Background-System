    ...
    <el-card>
      <div class="top-button">
        <div class="top-left-button">
          <el-button type="primary" plain :icon="Plus" @click="addNotify"
            >新增</el-button
          >
          <el-button type="success" plain :icon="Upload" @click="showExport"
            >导出</el-button
          >
        </div>
    ...
    >
      ...
      >
        ...
        <el-form-item label="选择数据" prop="data">
          <el-select v-model="exportForm.data">
            <el-option
...
const handleDelete = (row) => {
  ElMessageBox.confirm('您确定要删除吗？', '提示', {
    ...
    request
      .delete('/notification/delete/' + row.id)
      .then((res) => {
        if (res.code === 1) {
          getTableData()
          message('删除成功')
